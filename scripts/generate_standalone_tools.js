  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between h-16">
      ...
      <div class="hidden md:flex items-center gap-8">
        <a class="nav-link pb-0.5" href="/">홈</a>
        <a class="nav-link pb-0.5" href="/blog">뉴스</a>
        <a class="nav-link pb-0.5" href="/medicare">메디케어 &amp; ACA</a>
        <a class="nav-link pb-0.5 text-blue-600 font-bold" href="/tool">환자도우미</a>
        <a class="nav-link pb-0.5" href="/about">소개</a>
      </div>
    </div>
  </div>
</nav>
