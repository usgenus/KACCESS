  ...
  <nav class="fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-white/90 backdrop-blur-md border-b border-slate-200" style="top:45px">
    ...
    <!-- Mobile Menu -->
      ...
      <div class="mobile-accordion-group border-b border-slate-100">
        <button type="button" class="mobile-accordion-btn flex items-center justify-between w-full py-2.5 px-3 text-[15px] font-bold text-brand-blue hover:text-brand-blue hover:bg-slate-50/80 rounded-xl transition-colors text-left cursor-pointer" data-target="m-acc-senior">
          <div class="flex items-center gap-2.5">
        ...
        <div id="m-acc-senior" class="mobile-accordion-panel  bg-slate-50/80 rounded-xl p-2 my-1 border border-slate-100 flex flex-col gap-1">
