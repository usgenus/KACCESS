...
<body class="min-h-full flex flex-col bg-brand-light">
  ...
  <nav class="fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-white/80 backdrop-blur-sm" style="top:45px">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <!-- 아코디언 2: 뉴스 & 의학 칼럼 -->
      <div class="mobile-accordion-group border-b border-slate-100">
        <button type="button" class="mobile-accordion-btn flex items-center justify-between w-full py-2.5 px-3 text-[15px] font-bold text-brand-blue hover:text-brand-blue hover:bg-slate-50/80 rounded-xl transition-colors text-left cursor-pointer" data-target="m-acc-news">
          <div class="flex items-center gap-2.5">
        ...
        <div id="m-acc-news" class="mobile-accordion-panel  bg-slate-50/80 rounded-xl p-2 my-1 border border-slate-100 flex flex-col gap-1">
