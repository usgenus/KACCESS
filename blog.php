...
<body class="min-h-full flex flex-col bg-brand-light">
  ...
  <nav class="fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-white/80 backdrop-blur-sm" style="top:45px">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16">
        ...
        <div class="flex items-center gap-3">
          ...
          <a href="http://pf.kakao.com/_hdxmxaX/chat" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-1.5 bg-[#FEE500] hover:bg-[#FDD835] active:scale-95 text-black px-2.5 py-1 sm:px-3 sm:py-1.5 rounded-lg border border-yellow-400/80 shadow-xs hover:shadow-md transition-all duration-200 cursor-pointer" title="카카오톡 1:1 상담 바로가기"><img src="/kakaotalk-icon.png" alt="KakaoTalk" class="w-5 h-5 rounded-[4px] shrink-0 object-contain shadow-xs" /><span class="text-xs sm:text-sm font-black text-black tracking-tight whitespace-nowrap">1:1상담</span></a>
    ...
    <div id="mobile-menu-dropdown" class="md:hidden overflow-hidden transition-all duration-300 max-h-0 opacity-0 bg-white/95 backdrop-blur-md border-t border-brand-border px-4 py-4 flex flex-col gap-3">
      ...
      <a href="http://pf.kakao.com/_hdxmxaX/chat" target="_blank" rel="noopener noreferrer" class="flex items-center justify-center gap-2 bg-[#FEE500] hover:bg-[#FDD835] text-black font-black text-sm py-2.5 px-4 rounded-xl border border-yellow-400 shadow-sm mt-1"><img src="/kakaotalk-icon.png" alt="KakaoTalk" class="w-5 h-5 rounded-[4px] shrink-0 object-contain" /><span>1:1상담</span></a>
    </div>
  </nav>
