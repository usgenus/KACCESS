...
<body class="min-h-full flex flex-col bg-brand-light">
  ...
  <nav class="fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-white/80 backdrop-blur-sm" style="top:45px">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16">
        ...
        <div class="flex items-center gap-3">
          ...
          <a href="http://pf.kakao.com/_hdxmxaX/chat" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-1.5 bg-[#FEE500] hover:bg-[#FDD835] active:scale-95 text-black px-3 py-1.5 rounded-full border border-yellow-400 shadow-sm hover:shadow-md transition-all duration-200 cursor-pointer" title="카카오톡 1:1 상담 바로가기"><svg class="w-6 h-6 shrink-0" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 3C6.477 3 2 6.477 2 10.765c0 2.76 1.83 5.183 4.618 6.568l-.946 3.483c-.083.307.255.553.518.375l4.164-2.77c.535.056 1.083.084 1.646.084 5.523 0 10-3.477 10-7.765S17.523 3 12 3z" fill="#FEE500" stroke="#000000" stroke-width="0.8"/><path d="M7.74 8.79v4.42H6.55V9.83H5.2V8.79h3.74v1.04H7.74zm2.84 0l1.32 4.42h-1.22l-.24-.87H9.27l-.23.87H7.85l1.34-4.42h1.39zm-.37 2.61l-.34-1.29-.33 1.29h.67zm4.27 1.81h1.56v1h-2.75V8.79h1.19v4.42zm4.32-.97l1.19 1.97h-1.39l-.88-1.5-.47.46v1.04h-1.19V8.79h1.19v2.24l1.27-2.24h1.36l-1.08 1.85z" fill="#000000"/></svg><span class="text-[11px] sm:text-xs font-bold text-black tracking-tight whitespace-nowrap">카톡 1:1 상담</span></a>
    ...
    <div id="mobile-menu-dropdown" class="md:hidden overflow-hidden transition-all duration-300 max-h-0 opacity-0 bg-white/95 backdrop-blur-md border-t border-brand-border px-4 py-4 flex flex-col gap-3">
      ...
      <a href="http://pf.kakao.com/_hdxmxaX/chat" target="_blank" rel="noopener noreferrer" class="flex items-center justify-center gap-2 bg-[#FEE500] hover:bg-[#FDD835] text-black font-bold text-xs py-2.5 px-4 rounded-xl border border-yellow-400 shadow-sm mt-1"><svg class="w-6 h-6 shrink-0" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 3C6.477 3 2 6.477 2 10.765c0 2.76 1.83 5.183 4.618 6.568l-.946 3.483c-.083.307.255.553.518.375l4.164-2.77c.535.056 1.083.084 1.646.084 5.523 0 10-3.477 10-7.765S17.523 3 12 3z" fill="#FEE500" stroke="#000000" stroke-width="0.8"/><path d="M7.74 8.79v4.42H6.55V9.83H5.2V8.79h3.74v1.04H7.74zm2.84 0l1.32 4.42h-1.22l-.24-.87H9.27l-.23.87H7.85l1.34-4.42h1.39zm-.37 2.61l-.34-1.29-.33 1.29h.67zm4.27 1.81h1.56v1h-2.75V8.79h1.19v4.42zm4.32-.97l1.19 1.97h-1.39l-.88-1.5-.47.46v1.04h-1.19V8.79h1.19v2.24l1.27-2.24h1.36l-1.08 1.85z" fill="#000000"/></svg><span class="text-xs font-bold text-black">카카오톡 1:1 상담하기</span></a>
    </div>
  </nav>
  ...
  <aside id="kakao-floating-chat" class="fixed bottom-6 right-6 z-50 flex items-center group">
    <a href="http://pf.kakao.com/_hdxmxaX/chat" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 bg-[#FEE500] hover:bg-[#FDD835] text-black px-4 py-2.5 sm:px-4 sm:py-3 rounded-full border border-yellow-400 shadow-xl hover:shadow-2xl hover:scale-105 active:scale-95 transition-all duration-300 ring-4 ring-black/5" aria-label="카카오톡 1:1 상담">
      <svg class="w-7 h-7 shrink-0" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 3C6.477 3 2 6.477 2 10.765c0 2.76 1.83 5.183 4.618 6.568l-.946 3.483c-.083.307.255.553.518.375l4.164-2.77c.535.056 1.083.084 1.646.084 5.523 0 10-3.477 10-7.765S17.523 3 12 3z" fill="#FEE500" stroke="#000000" stroke-width="0.8"/><path d="M7.74 8.79v4.42H6.55V9.83H5.2V8.79h3.74v1.04H7.74zm2.84 0l1.32 4.42h-1.22l-.24-.87H9.27l-.23.87H7.85l1.34-4.42h1.39zm-.37 2.61l-.34-1.29-.33 1.29h.67zm4.27 1.81h1.56v1h-2.75V8.79h1.19v4.42zm4.32-.97l1.19 1.97h-1.39l-.88-1.5-.47.46v1.04h-1.19V8.79h1.19v2.24l1.27-2.24h1.36l-1.08 1.85z" fill="#000000"/></svg>
      <span class="text-xs font-bold text-black tracking-tight hidden sm:inline-block">카톡 1:1 상담</span>
    </a>
  </aside>
